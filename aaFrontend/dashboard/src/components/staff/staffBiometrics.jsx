...
export default function StaffBiometrics() {
  ...
  const canvasSize = Math.round(completedCrop ? 
    Math.min(completedCrop.width, completedCrop.height) : 0);
                  ...
                  <div className="col-md-6">
                    <div className="card h-100">
                      <div className="card-header bg-light d-flex justify-content-between align-items-center">
                        ...
                        <div>
                          {!addImg && selectedStaff.images && selectedStaff.images.length < MAX_PHOTOS && (
                            <button
                      ...
                      <div className="card-body">
                        {addImg ? (
                              ...
                              {!imgSrc && (
                                <div className="text-center">
                                  ...
                                  <p className="text-muted small">
                                    Please select a clear face image for better recognition
                                  </p>
                                </div>
                              )}
                            </div>
                          ...
                          <div className="text-center">
                            {selectedStaff.images && selectedStaff.images.length > 0 ? (
                              <div className="staff-photos">
                                <div className="row">
                                  {selectedStaff.images.map((imgObj, index) => (
                                    <div key={index} className={`${selectedStaff.images.length === 1 ? 'col-sm-8' : 'col-sm-4'} mb-3`}>
                                ...
                                <div className="text-muted mt-2 small">
                                  {MAX_PHOTOS - selectedStaff.images.length} of {MAX_PHOTOS} photos remaining
                                </div>
                              </div>
                            ) : (
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="fingerprint-section">
                              <h6 className="text-primary mb-3">Fingerprint Status</h6>
                          ...
                          <div className="col-md-6">
                            <h6 className="text-primary mb-3">Other Biometrics</h6>
                            <div className="alert alert-info">
                              <i className="bi bi-credit-card-2-front me-2"></i>
                              Additional biometric options will be available in future updates
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            {!isStaffSelected && !loading && (
              <div className="text-center py-5">
                <div className="empty-state">
                  ...
                  <p className="text-muted">Please select a staff member from the dropdown above to view and manage their biometric data</p>
                </div>
              </div>
            )}
          </div>
