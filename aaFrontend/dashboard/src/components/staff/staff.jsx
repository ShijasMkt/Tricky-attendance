		...
		if (res.ok) {
			...
			toast.current
				.show({
					...
					detail: "you've successfully deleted a staff",
					life: 3000,
				})
				fetchStaffs();
		}
	...
	const deleteStaffDialogFooter = (
		<React.Fragment>
			<Button
				...
				icon="pi pi-times"
				outlined
				onClick={() => setDeleteStaffDialog(false)}
			/>
			<Button
				label="Yes"
				icon="pi pi-check"
	...
	return (
		<div className="section-body">
			...
			<div className="container pt-3">
				...
				<Dialog
					header={`Staff #${selectedStaff.staff_id}`}
					className="staff-view-box"
					visible={staffView}
					style={{ width: "50vw" }}
				...
				<Dialog
					...
					header="Confirm"
					modal
					onHide={() => setDeleteStaffDialog(false)}
				>
