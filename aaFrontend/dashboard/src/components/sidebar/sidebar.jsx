...
export default function Sidebar() {
    ...
    const isActive = (item) => {
        if (item.subItems) {
            return item.subItems.some(subItem => location.pathname === subItem.path) || expandedMenu === item.label;
        }
    ...
    return (
        <div className="sidebar-body">
            <div className="logo">
                <img className="img-fluid" src="src/assets/logo.svg" alt="Logo" width={150} />
            </div>
